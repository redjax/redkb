...
> [!NOTE] Example app using repository class
> To see an example of one of my apps that uses this pattern, check [`auto-xkcd`](https://github.com/redjax/auto-xkcd/).
>
> - [`auto_xkcd.domain.xkcd.comic`](https://github.com/redjax/auto-xkcd/tree/main/packages/domain/src/domain/xkcd) for models, schemas, and repositories.
> - [`auto_xkcd.core.database`](https://github.com/redjax/auto-xkcd/tree/main/libs/database-lib/src/db_lib) for SQLAlchemy code.
> - To see the repository in action, check the `save_comic_to_db()` method in the [`auto_xkcd.modules.xkcd_mod.methods`](https://github.com/redjax/auto-xkcd/blob/main/packages/xkcdapi/src/xkcdapi/db_client/__methods.py) module.
