...
Helpers & `nox` sessions for `Django` projects. Expects the existence of a [`nox_extra/nox_utils.py`](index.md#nox-extranox-utilspy) file to exist, this script imports some values from the common utils file.
